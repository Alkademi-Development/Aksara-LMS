<template>
    <div>
        ...
        <div class="container-fluid mt-4">
            ...
            <PreviewCreateClass v-if="activeStep == 'preview'" isEditPage :detailOverview="classroomDetail" :isClassDetailLoaded="isLoaded" @changeStep="changeStep" />
...
import CreateClassroomForm from "@/components/template/micro/form/CreateClassroomForm"
